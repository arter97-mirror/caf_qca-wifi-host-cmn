 ...
 * @desc_list: Pointer to array where descriptors will be stored
 * @count: Pointer to variable that will be updated with number of descriptors
 * retrieved
 * @budget: Maximum number of descriptors to retrieve
 *
 * This wrapper function handles ring locking, access start/end, and
 ...
 * completion descriptor retrieval. The descriptors are stored in the
 * desc_list array and the count is updated.
 *
 * Return: 0 on success, negative error code on failure
 */
