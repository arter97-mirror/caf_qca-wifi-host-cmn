...
/**
 * ucfg_twt_tgt_caps_get_p2p_go_concurrency_support() - This API is wrapper for
 * function "wlan_twt_tgt_caps_get_p2p_go_concurrency_support"
 * @psoc: psoc handle
 * @val: pointer to get caps enabled/disabled
 *
 * return: QDF_STATUS
...
/**
 * ucfg_twt_tgt_caps_get_resp_disable_per_vdev() - This API is wrapper for
 * function "wlan_twt_tgt_caps_get_resp_disable_per_vdev"
 * @psoc: psoc handle
 * @val: pointer to get caps enabled/disabled
 *
 * return: QDF_STATUS
 */
QDF_STATUS
ucfg_twt_tgt_caps_get_resp_disable_per_vdev(struct wlan_objmgr_psoc *psoc,
					    bool *val);

/**
 * ucfg_twt_handle_p2p_chan_usage_unavail() - Handle P2P channel usage
 * unavailability
 * @psoc: psoc pointer
