 ...
 * Current implementation conforms to database version 50.
 */
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(ANTARCTIA, NULL1_WORLD, 0, AQ, 40, 160, 0, 0),
	...
	CE(KOREA_ROC, APL9_KRRA, APL7_6G_19, KR, 40, 160, 320, 0),
	...
	CE(SINGAPORE, APL20_WORLD, ETSI2_6G_0C, SG, 40, 160, 320, 0),
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(BHUTAN, ETSI1_WORLD, 0, BT, 40, 160, 0, 0),
	CE(BOLIVIA, FCC17_WORLD, 0, BO, 40, 160, 0, 0),
	CE(BONAIRE_SINT_EUSTATIUS_AND_SABA, ETSI21_WORLD, ETSI1_6G_02, BQ, 40,
	   160, 320, 0),
	CE(BOSNIA_HERZ, ETSI20_WORLD, 0, BA, 40, 160, 0, 0),
	CE(BOTSWANA, ETSI20_WORLD, ETSI1_6G_02, BW, 40, 160, 320, 0),
	CE(BOUVET_ISLAND, ETSI10_WORLD, ETSI1_6G_02, BV, 40, 160, 320, 0),
	CE(BRAZIL, FCC21_ETSIC, FCC1_6G_07, BR, 40, 160, 320, 0),
	CE(BRITISH_INDIAN_OCEAN_TERRITORY, ETSI21_WORLD, ETSI2_6G_03, IO, 40,
	   160, 320, 0),
	CE(BRUNEI_DARUSSALAM, FCC17_WORLD, 0, BN, 40, 160, 0, 0),
	...
	CE(HONDURAS, FCC13_WORLD, APL8_6G_22, HN, 40, 160, 320, 0),
	CE(HONG_KONG, ETSI21_WORLD, ETSI2_6G_03, HK, 40, 160, 320, 0),
	...
	CE(PANAMA, FCC14_FCCB, 0, PA, 40, 160, 0, 0),
	CE(PAPUA_NEW_GUINEA, FCC17_WORLD, 0, PG, 40, 160, 0, 0),
	CE(PARAGUAY, ETSI21_WORLD, APL5_APL9_6G_23, PY, 40, 160, 0, 0),
	CE(PERU, FCC17_WORLD, FCC1_6G_05, PE, 40, 160, 320, 0),
	CE(PHILIPPINES, ETSI9_WORLD, ETSI1_6G_02, PH, 40, 160, 320, 0),
	CE(PITCAIRN, ETSI21_WORLD, ETSI2_6G_03, PN, 40, 160, 320, 0),
...
static const struct sixghz_super_to_subdomains g_6g_reg_dmn_9_tuples[] = {
	...
	{APL10_6G_27, APL10_AP_LPI_6G, 0, APL8_AP_VLP_6G,
	 {APL10_CLI_LPI_6G, APL10_CLI_LPI_6G},
	 {0, 0},
	 {APL8_CLI_VLP_6G, APL8_CLI_VLP_6G} },
...
static const struct sub_6g_regdomain sub_regdomains_6g[] = {
	...
	[APL10_AP_LPI_6G]  = {2, 320, 1, {CHAN_5925_6425_5} },
