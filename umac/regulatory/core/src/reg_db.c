 ...
 * Current implementation conforms to database version 47.
 */
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(CANADA, FCC22_FCCA, FCC2_6G_20, CA, 40, 160, 320, 0),
	...
	CE(ESWATINI, ETSI27_WORLD, 0, SZ, 40, 160, 0, 0),
	...
	CE(KAZAKHSTAN, MKK5_MKKC, ETSI1_6G_02, KZ, 40, 160, 320, 0),
	...
	CE(VIET_NAM, ETSI29_WORLD, ETSI1_6G_02, VN, 40, 160, 0, 0),
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(VANUATU, FCC17_WORLD, FCC1_6G_01, VU, 40, 160, 320, 0),
	CE(VENEZUELA, FCC2_ETSIC, FCC1_6G_01, VE, 40, 160, 320, 0),
	CE(VIET_NAM, ETSI22_WORLD, ETSI1_6G_02, VN, 40, 160, 0, 0),
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(COSTA_RICA, FCC17_WORLD, APL4_6G_11, CR, 40, 160, 320, 0),
	CE(COTE_DIVOIRE, ETSI2_WORLD, 0, CI, 40, 160, 0, 0),
	CE(CROATIA, ETSI25_WORLD, 0, HR, 40, 160, 0, 0),
	CE(CURACAO, APL10_WORLD, ETSI1_6G_02, CW, 40, 160, 320, 0),
