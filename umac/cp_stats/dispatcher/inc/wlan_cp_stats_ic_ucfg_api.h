...
UCFG_PDEV_CP_STATS_SET_FUNCS(recovery_start_ts);
UCFG_PDEV_CP_STATS_SET_FUNCS(recovery_complete_ts);
UCFG_PDEV_CP_STATS_SET_FUNCS(avg_recovery_time);
...
UCFG_PDEV_CP_STATS_GET_FUNCS(recovery_start_ts);
UCFG_PDEV_CP_STATS_GET_FUNCS(recovery_complete_ts);
UCFG_PDEV_CP_STATS_GET_FUNCS(avg_recovery_time);
