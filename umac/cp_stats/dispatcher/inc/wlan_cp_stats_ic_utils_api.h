...
VDEV_MCAST_CP_STATS_SET_FUNCS(rx_decryptcrc);
...
VDEV_CP_STATS_SET_FUNCS(rx_mgmt_sw_decrypt);
VDEV_CP_STATS_SET_FUNCS(rx_mgmt_sw_decrypt_fail);
...
PDEV_CP_STATS_SET_FUNCS(recovery_start_ts);
PDEV_CP_STATS_SET_FUNCS(recovery_complete_ts);
PDEV_CP_STATS_SET_FUNCS(avg_recovery_time);
...
PDEV_CP_STATS_GET_FUNCS(recovery_start_ts);
PDEV_CP_STATS_GET_FUNCS(recovery_complete_ts);
PDEV_CP_STATS_GET_FUNCS(avg_recovery_time);
