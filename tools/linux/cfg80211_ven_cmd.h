...
enum _ol_ath_param_t {
	...
	OL_ATH_PARAM_UL_OFDMA_RTD = 556,
	OL_ATH_PARAM_DUMP_ALL_NON_EGDE_NODES = 557,
};
...
struct vendor_commands radio_vendor_cmds[] = {
	...
	{"dump_all_non_edge_nodes",
		OL_ATH_PARAM_SHIFT |  OL_ATH_PARAM_DUMP_ALL_NON_EGDE_NODES, GET_PARAM, 0}
