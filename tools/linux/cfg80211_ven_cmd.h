...
enum {
	...
	IEEE80211_PARAM_VAP_TX_POWER = 843,
...
struct vendor_commands vap_vendor_cmds[] = {
	...
	{"g_enable_rtt",        IEEE80211_PARAM_RTT_ENABLE, GET_PARAM, 0},
	...
	{"get_txpower_resolution", IEEE80211_PARAM_VAP_TX_POWER, GET_PARAM, 0},
};
...
struct vendor_commands radio_vendor_cmds[] = {
	...
	{"ap_power_mode",
		...
		SET_PARAM, 1},
	{"g_enable_rtt",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_RTT_ENABLE, GET_PARAM, 0},
	{"g_client_type",
	...
	{"display_blacklist_chan_list",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_DISPLAY_BLACKLIST_CHANNEL_LIST, GET_PARAM, 0},
#ifdef WLAN_MGMT_RX_REO_SUPPORT
