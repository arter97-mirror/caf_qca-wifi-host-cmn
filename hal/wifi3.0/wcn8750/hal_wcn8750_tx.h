...
/**
 * hal_tx_update_dscp_tid_8750() - Update the dscp tid map table as updated
 *					by the user
 * @hal_soc: HAL SoC context
 * @tid: TID
 * @id : MAP ID
 ...
 * Return: void
 */
static void hal_tx_update_dscp_tid_8750(struct hal_soc *hal_soc, uint8_t tid,
...
/**
 * hal_tx_init_cmd_credit_ring_8750() - Initialize command/credit SRNG
 ...
 */
static inline void
hal_tx_init_cmd_credit_ring_8750(hal_soc_handle_t hal_soc_hdl,
...
/**
 * hal_tx_config_rbm_mapping_be_8750() - Update return buffer manager ring id
 ...
 */
static inline void
hal_tx_config_rbm_mapping_be_8750(hal_soc_handle_t hal_soc_hdl,
				  hal_ring_handle_t hal_ring_hdl,
				  uint8_t rbm_id)
{
