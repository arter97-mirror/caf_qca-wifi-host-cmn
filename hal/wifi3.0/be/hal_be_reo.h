...
static inline void
hal_reo_flush_timeout_list_status_be(hal_ring_desc_t ring_desc, void *st_handle,
				     hal_soc_handle_t hal_soc_hdl)
{
}

static inline void
hal_reo_desc_thres_reached_status_be(hal_ring_desc_t ring_desc, void *st_handle,
				     hal_soc_handle_t hal_soc_hdl)
{
}
