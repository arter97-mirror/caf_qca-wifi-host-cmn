...
#define STR_TX_DSCP_HIGH_PRI_DEFAULT_ARRAY "24, 26, 32, 34, 36, 38, 40, 46, 48, 56"
#define CFG_TX_DSCP_HIGH_PRI_ARRAY CFG_INI_STRING( \
			"tx_dscp_high_pri_array", \
			0, \
			64, \
			STR_TX_DSCP_HIGH_PRI_DEFAULT_ARRAY, \
			"tx dscp high priority values array")
...
#define CFG_HDD_DP_ALL \
	...
	CFG(CFG_TX_DSCP_HIGH_PRI_ARRAY) \
